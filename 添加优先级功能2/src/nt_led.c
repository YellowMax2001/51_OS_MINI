...
uchar wei[]  = {0xF0,0xF1,0xF2,0xF3,0xF4,0xF5};

uchar dula_yin[] = {0x3f,0x06,0x5b,0x4f, 0x66,0x6d,0x7d,0x07,0x7f,0x6f,0x77,0x7c, 0x39,0x5e,0x79,0x71};
uchar wela_yin[] = {0xFE,0xFD,0xFB,0xF7}; 
